...
function ConfirmAccount() {
  ...
  return (
    <Fragment>
        ...
        <div className='w-1/2 flex justify-center items-center min-h-screen bg-white '>
          <div className='w-[424px]'>
            ...
            <div className='mt-6 text-center'>
              <span className='text-gray-600'>Xác nhận thông tin thành công vui lòng bấm vào tiếp tục để tận hường mua hàng </span>
            </div>
            <Link to="/login">
              <button type="submit" className="w-[424px] bg-[#5D5FEF] text-white py-2 rounded-md hover:bg-[#2d2ff7] transition duration-300 mt-[25px]">Tiếp tục</button>
            </Link>
      ...
      </body>) : (<div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
