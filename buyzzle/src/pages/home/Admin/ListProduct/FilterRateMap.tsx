    ...
    return (
        <div className="col-span-1 flex gap-3 items-center
            ...
            <input
                id="default-checkbox"
                type="checkbox"
                className="w-4 h-4 accent-[#EA4B48] max-lg:w-3 max-[850px]:w-[10px]"
            />
            ...
            <div className="flex items-center space-x-1 ">
                {[1, 2, 3, 4, 5].map((item) => {
                    return (
                        <svg
                            className={`w-4 h-4 max-lg:w-3 max-[850px]:w-[10px] ${props.rating >= item ? `text-yellow-300` : `text-[#CCCCCC]`
                                }`}
                            aria-hidden="true"
