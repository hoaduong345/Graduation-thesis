   ...
   return (
      ...
      >
       ...
       hover:rounded-[6px] cursor-pointer hover:bg-[#FFEAE9] hover:text-[#EA4B48] pl-7"
         ...
         {/* MessagesIconSitebar */}
         <div
            className=" w-[100%] flex items-center py-2 transition duration-200
       hover:rounded-[6px] cursor-pointer hover:bg-[#FFEAE9] hover:text-[#EA4B48] pl-7"
         >
            <MessagesIcon />
            <span className="text-sm font-bold text-[#1A1A1A] mx-[23px]">
               <a href="#">Tin Nhắn</a>
            </span>
            <div
               className=" inline-flex items-center justify-center w-7 h-6 px-2 py-1 text-xs font-bold text-white
         bg-[#FF6E01] rounded-full"
            >
               20
            </div>
         </div>
