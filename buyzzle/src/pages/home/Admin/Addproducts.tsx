                ...
                <div className="back h-[57px] mt-[46px] ">
                    <div className="flex gap-3 items-center">
                        ...
                        <div>
                            ...
                            <h2 className="uppercase text-[32px] font-bold">
                                Thêm Sản Phẩm
                            </h2>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <Controller
                                            ...
                                            render={({ field }) => (
                                                <>
                                                    <label
                                                        htmlFor="name"
                                                        className="text-[#4C4C4C] text-sm font-semibold mb-[8px]"
                                                    >
                                                        Tên Sản Phẩm*
                                                    </label>
                                        ...
                                        <Controller
                                            ...
                                            rules={{
                                                ...
                                                minLength: {
                                                    value: 20,
                                                    message:
                                                        "Mô tả sản phẩm tối thiểu 20 ký tự!",
                                                },
                                            }}
                                            render={({ field }) => (
                                                <>
                                                    <p className="text-[#4C4C4C] text-sm font-semibold mb-[8px] mt-[23px]">
                            ...
                            shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]"
                                    >
                                        ...
                                        <div className=" w-[100%] flex border-[1px] border-[#FFAAAF] rounded-[6px] items-center">
                                            <select
                                                className="w-[100%] p-2.5 text-gray-500 bg-white py-[14px] outline-none "
                                                onChange={(na) => {
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    {/* card */}
                                    <div
                                        className="card w-[100%] py-4 px-9 mt-2 flex items-center
                                shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]"
                                    >
                                        <Controller
                                            control={control}
                                                    ...
                                                    <div className="max-w-max items-center">
                                                        <label htmlFor="images">
                                                            <div className="outline-dashed outline-2 outline-offset-2 outline-[#EA4B48] py-7 px-9 cursor-pointer">
                                                                ...
                                                                >
                                                                    <p className="text-[#5D5FEF] text-center -tracking-tighter font-bold">
                                                                        Click to upload
                                                                        <span className="text-[#1A1A1A] font-normal text-sm tracking-widest">
                                                                            or drag and drop
                                                                        </span>
                                                                    </p>
                                                                </div>
                                                        ...
                                                        <div className="col-span-4">
                                                            ...
                                                            >
                                                                <input
                                                                    ...
                                                                    onChange={field.onChange}
                                                                />
                                                                <p className="text-[#7A828A] font-bold ml-4 cursor-default">
                                                                    VNĐ
                                                                </p>
                                                            </div>
                                                            {errors.productPrice && (
                            ...
                            shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]"
                                    >
                                        <p className="text-[#4C4C4C] text-sm font-semibold mb-[18px]">
                                            Tình trạng sản phẩm*
                                        </p>
                                        <div className="flex text-center  w-16 justify-start gap-5">
                                            <h3 className="text-[#4C4C4C] font-semibold">
                                                Ẩn
                                            </h3>
                                            {/* Swich */}
                                            ...
                                            {/* end  Swich */}
                                            <h3 className="text-[#5D5FEF] font-semibold">
                                                Đăng
                                            </h3>
                                        </div>
                                    </div>
