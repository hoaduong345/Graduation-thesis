                    ...
                    <div className="flex flex-col gap-3 p-[26px]">
                      ...
                      <div>
                        <p className="text-sm font-normal text-[#1A1A1A] max-[870px]:text-xs">
                          ...
                          12 Nguyễn Chí Thanh Phường Tân An, Thành Phố Buôn Ma
                          Thuột, Đắk Lắk
                        </p>
                      </div>
                    </div>
                            ...
                            <div className="flex flex-col gap-1">
                              ...
                              <div>
                                <p className="text-[13px] font-normal text-[#4C4C4C]">
                                  12 Nguyễn Chí Thanh Phường Tân An, Thành Phố
                                ...
                                render={({ field }) => (
                                  <>
                                    ...
                                    >
                                      ...
                                      <option>
                                        Phường Thống Nhất, Thành Phố Buôn Ma
                                        Thuột, Đắk Lắk
                                      </option>
                                      <option>
                ...
                <div className="col-span-1 flex flex-col gap-5 p-[20px] shadow">
                  ...
                  <div className="flex flex-col gap-2">
                    <p className="text-sm font-medium text-[#1A1A1A] max-[870px]:text-[13px]">
                      Ghi chú cho (
                      <span className="text-[#7A828A]">Người gửi</span>
                      ):{" "}
                    </p>
                    <textarea
                          ...
                          <>
                            ...
                            >
                              <input
                                ...
                                name="choose"
                                type="radio"
                                onChange={() => paymentChecked(element.id)}
                              />
                              <div className="w-6">
                                <img
