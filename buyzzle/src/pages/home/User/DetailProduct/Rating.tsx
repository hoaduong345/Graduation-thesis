...
export default function Rating() {
  const [rateAndcomment, setRateAndcomment] = useState<RatingComment[]>([]);
  const { id } = useParams();
  console.log(id);
  useEffect(() => {
  ...
  const getComment = (id: number) => {
    RatingAndCommentController.getRatingAndComment(id).then((res) => {
          ...
          <div className="col-span-2 ">
            <div className="border-t-[1px] border-[#EA4B48] px-11 py-8">
              ...
              {/* <p className="text-[#4C4C4C]">
                rating.commentrating.commentrating.comment
              </p> */}
              {/* end content comment */}
