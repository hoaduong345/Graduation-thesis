...
export default function DetailRecommandProduct({ productRecommand }: { productRecommand: Products }) {
    ...
    return (
        <>
            ...
            <div
                ...
                <img className="h-[207px] w-[100%] max-2xl:h-[247px]  max-lg:h-[347px] "
                    alt="" src={productRecommand.ProductImage[0].url} />
                <div className="p-[10px] border-x-[1px] border-b-[1px] border-[#FFAAAF] 
        max-2xl:max-h-max 
        max-lg:h-[180px]
        ">

                    <p className="font-bold text-base max-xl:text-[15px] break-words truncate
          max-2xl:text-[15px]
          max-lg:text-2xl
          max-lg:mt-4
          ">{productRecommand.name}</p>
          ...
          max-lg:text-[10px]
            ">
                            Giảm {numberFormat(productRecommand.price * (productRecommand.discount / 100))}k
                        </div>
          ...
          max-lg:text-2xl
            ">
                            {numberFormat(productRecommand.price - (productRecommand.price * (productRecommand.discount / 100)))}
                        </p>

                    </div>

                    <div className='flex justify-between max-2xl:items-center
          max-lg:mt-2
          '>
                        <div>
                            <button>
                            ...
                            <span className="text-[12px] mr-[30px] ml-[4px] max-lg:text-base">{4.2}</span>
                        </div>
