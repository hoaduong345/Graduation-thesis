    ...
    return (
        <Container>
            <div >
                ...
                <div className='bg-white h-[91px] mt-[50px] rounded-md items-center flex
                shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]'>
                    <div className='w-[5%] text-center leading-none	'>
                        <input type="checkbox" className="checkbox checkbox-sm items-center" />
                    </div>
                    <div className='w-[40%]'>
                ...
                <div>
                    ...
                    <div className='overscroll-auto md:overscroll-contain lg:overscroll-none h-[630px] overflow-x-hidden mt-[72px]'>
                        <div className='bg-white h-auto  rounded-md items-center flex py-[40px]
                shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]'>
                            <div className='w-[5%] text-center leading-none	'>
                                <input type="checkbox" className="checkbox checkbox-sm items-center" />
                            </div>
                            ...
                            <div className='flex w-[40%]'>
                                <img src={Images.product} className='w-[112px] h-[112px]' alt="product" />
                                <div>
                                    <p className='text-[#1A1A1A] text-base font-medium mx-3'>Ly giữ nhiệt cao cấp Tyeso V2 900ml cốc nước giữ nhiệt thể thaow-[5%]w-[5%]w-[5%]w-[5%]w-[5%]</p>
                            ...
                            <div className='w-[18.2%]'>
                                <div className='flex'>
                                    {/* Số tiền đầu */}
                                    <p className='text-[#7A828A] text-xs line-through leading-none	'>60.000</p> {/* end Số tiền đầu */}
                                    {/* Số tiền sau giảm giá */}
                                    <p className='text-[#EA4B48] text-xl'>30.000</p>{/* end Số tiền sau giảm giá */}
                                </div>
                            </div>{/* end Đơn giá */}
                ...
                shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]'>
                    ...
                    {/* fixed */}
                    <div className='bg-white mt-[50px] items-center
                shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]'>
                        {/* Input voucher */}
                            ...
                            <div className='p-4 flex items-center w-[35%]'>
                                ...
                                <div className='flex w-[40%] text-[#1A1A1A] text-base'>
                                    ...
                                    <div className='mx-2 gap-2'>
                                        (231443)
                                    </div>{/* end Tổng số lượng được tick chọn trong giỏ hàng */}
                                </div>
                                {/* Xóa */}
                                <div className='rounded-full shadow-[rgba(108,_108,_108,_0.25)_0px_0px_4px_0px]
                        '>
                                    <div className='p-3'>
                                        <Delete />
                                    </div>
                            ...
                            <div className='flex items-center justify-between w-[55%] p-4' >
                                ...
                                <div><p >Tổng thanh toán (323 sản phẩm):</p></div> {/* end Tổng số sản phẩm thanh toán  */}
                                {/* Tiền */}
                                <div className='flex items-center gap-2'>
                                    <div>
                                        <p className='text-[#EA4B48] text-3xl'>₫180.000</p>{/* end Tiền những sản phẩm đã chọn */}
                                        <div className='flex'>
                                            <p>Tiết kiệm : </p>
                                            {/* Tiết kiệm */}
                                            <p className='ml-2 text-[#EA4B48]'>đ30k</p>{/* Tiết kiệm */}
                                        </div>
                                    </div>
                                    <ArrowUp />
                                </div>

                                <button className='justify-center gap-3 items-center text-lg font-bold text-white w-[287px]
