...
export default function UserProfile() {
    ...
    const addImages = async (id: number, url: string) => {
        ...
        await axios.post(`${appConfigUser.apiUrl}/addimageuser`, urlImages)
                                                    ...
                                                    <div className='w-[100%] h-[100%]'>
                                                        {selectedFile ? (
                                                            <>
                                                                ...
                                                                <img src={url!} alt="Selected" width={"100%"} className='object-cover' height={"100%"} />
                                                            </>
                                                        ) : (
                                                            <div className='w-[174px]'>
                                                                ...
                                                                {CheckImageUrl ? (
                                                                    <>
                                                                        <img src={urlThen!} alt="Selected" width={"100%"} className='object-cover' height={"100%"} />
                                                                    </>
                                                                ) : (
