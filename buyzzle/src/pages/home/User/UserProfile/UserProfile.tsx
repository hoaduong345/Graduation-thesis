                        ...
                        <div>
                            <div className='grid grid-cols-4 gap-4'>
                                ...
                                <div className='mt-9 col-span-3 max-2xl:col-span-1 grid grid-cols-5 gap-4'>
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)} className='card py-4 px-5 col-span-3  rounded-[6px] shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]'
                                    >
                                            ...
                                            <div className='w-[48%]'>
                                                <Controller control={control} name='name' rules={{
                                                    ...
                                                    <>
                                                        ...
                                                        {/* input addNameProducts */}
                                                        <input
                                                            className={`focus:outline-none text-[#333333] text-base placeholder-[#7A828A] rounded-[6px] px-[10px] py-[12px] w-[100%] mt-2
                            ...
                            <div className='grid grid-cols-4 gap-4'>
                                ...
                                <div className='mt-9 col-span-3 max-2xl:col-span-1 grid grid-cols-5 gap-4'>
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit2)} className='card py-4 px-5 rounded-[6px] col-span-5 shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]'>
                                        ...
                                        <div className='w-[100%]'>
                                            {/* <div className='w-[100%]'> */}
                                            <Controller control={control} name='oldPassword' rules={{
                                                required: {
                                                    value: true,
                                                    message: 'Bạn phải nhập thông tin cho trường dữ liệu này!'
                                                },
                                                ...
                                                <>
                                                    <label htmlFor='name' className='text-[#4C4C4C] text-sm font-medium'>Mật khẩu hiện tại</label>
                                                    {/* input addNameProducts */}
                                                    ...
                                                    {!!errors.oldPassword && <p className='text-red-700 mt-2'>{errors.oldPassword.message}</p>}</>
                                            )} />
                                            {/* </div> */}
                                            <div className='flex w-[100%] justify-between  mt-4'>
                                                <Controller control={control} name='newPassword' rules={{
                                                    required: {
                                                        value: true,
                                                        message: 'Bạn phải nhập thông tin cho trường dữ liệu này!'
                                                    },
                                                    ...
                                                    <>
                                                        ...
                                                        {/* input addNameProducts */}
                                                        <div className='w-[48%]'>
                                                            <label htmlFor='name' className='text-[#4C4C4C] text-sm font-medium'>Mật khẩu mới</label>
                                                            <div className="relative w-full items-center">
                                                                <button
                                                                    type='button'
                                                                    className='absolute right-4 top-8 transform -translate-y-1/2 text-gray-500'
                                                ...
                                                <Controller control={control} name='confirmNewPassword' rules={{
                                                    ...
                                                    <>
                                                        ...
                                                        {/* input addNameProducts */}
                                                        <div className='w-[48%]'>
                                                            <label htmlFor='name' className='text-[#4C4C4C] text-sm font-medium'>Xác nhận mật khẩu mới</label>
                                                            <div className="relative w-full items-center">
                                                                <button
                                                                    type='button'
                                                                    className='absolute right-4 top-8 transform -translate-y-1/2 text-gray-500'
