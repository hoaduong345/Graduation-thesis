        ...
        <div className='max-w-[310px] shadow shadow-[#ffaaaf]'>
            <div className='relative figure'>
                ...
                <div className='absolute right-[0] top-[0] py-[13px] px-[8px] bgFlashSale' >
                    ...
                    <span className='text-[32px] text-[#efd22b]'>{props.flashSaleItem.giamGia}%</span>
                </div>

            </div>

            <div className='p-[10px]'>
                <p className='font-bold text-[16px] my-[3px] max-w-[268px]'>{props.flashSaleItem.title}</p>
                ...
                <div className='flex justify-between items-center'>
                    <p className='text-[16px] text-[#865546] font-bold'>{thanhTien} vnd</p>
                </div>
