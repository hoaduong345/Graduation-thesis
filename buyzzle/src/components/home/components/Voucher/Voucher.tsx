...
export default function VoucherHomePage() {
  ...
  //         localStorage.setItem("voucher", JSON.stringify([...dataVoucherLocal]));
  ...
  const savedVoucher = (id: number) => {
    console.log("🚀 ~ file: Voucher.tsx:47 ~ savedVoucher ~ id:", id);
    voucherControllers
      .userSavedVoucher(id)
      .then((_) => {
              ...
              <>
                <div className="col-span-1 relative ">
                  ...
                  <div className="absolute left-[8%] top-[17%] flex flex-col gap-3 items-center">
                    ...
                    <p className="text-[#4C4C4C] text-left absolute left-0 top-20">
                      {e.quantity}
                    </p>
                  </div>
